...
Use a friendly, encouraging tone, content should be on behalf of an organisation(Name - Splitr). Format your response in HTML(only HTML content to embed in existing HTML schema, exclude any greetings text & HTML boilerplate) for an email.
            ...
            try {
                ...
                await step.run(`Email · ${user._id}`, () =>
                    convex.action(api.email.sendEmail, {
                        // to: user.email,
                        to: "psinghp888@gmail.com", // for testing
